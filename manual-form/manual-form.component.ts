...
export class ManualFormComponent implements OnInit, OnDestroy {
    ...
    public selectFator() {
        console.log(this.dataTableFator)
    ...
    public orderList(event){
        // console.log(this.manual.fatoresAjuste)
        ...
        if (event.button == 'order-top' && event.selection != null) {
            ...
            console.log(this.manual.fatoresAjuste.unshift(event.selection));
            console.log("o index é depois: " + this.manual.fatoresAjuste.indexOf(event.selection))
            ...
            if(i == this.manual.fatoresAjuste.length){
                console.log("já está no final")
                return 
            } else{
                let pos = i ++ 
                this.manual.fatoresAjuste.splice(del, 1)
                console.log(this.manual.fatoresAjuste.splice( pos,0, event.selection))
                console.log("o index é depois: " + this.manual.fatoresAjuste.indexOf(event.selection))
            }
            ...
            this.manual.fatoresAjuste.splice(del, 1)
            console.log(this.manual.fatoresAjuste.push(event.selection));
            console.log("o index é depois: " + this.manual.fatoresAjuste.indexOf(event.selection))
        }
    }
}
